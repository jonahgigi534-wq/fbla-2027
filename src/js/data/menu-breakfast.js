  ...
  createCategory(
    ...
    [
      ...
      createItem(
        ...
        'Sunshine Breakfast',
        1245,
        '2 Eggs, 4 oz Peaches, Half Meat Choice, 1 Side Choice, 1 Bread Choice'
      ),
      createItem(
  ...
  createCategory(
    ...
    [
      createItem(
        ...
        { popular: true, imageId: 'sausage-scrambler' }
      ),
      createItem(
        'huevos-rancheros',
        'Huevos Rancheros',
        1295,
        '2 Scrambled Eggs, Flour Tortilla, Picante, Cheddar and Jack Cheese, Frijoles, 1 Side Choice'
      ),
      createItem(
        'acapulco-breakfast',
        'Acapulco Breakfast',
        1295,
        '2 Scrambled Eggs, Taco Meat, Cheddar and Jack Cheese, Frijoles, 1 Side Choice, Flour Tortillas'
      ),
      createItem(
        'eggs-benedict',
        'Eggs Benedict',
      ...
      createItem(
        ...
        'Eggsadillas',
        1195,
        "2 Eggs Scrambled, O'Brien Potatoes, Sausage, Cheddar Cheese, Between 2 Flour Tortillas, Frijoles, Picante, Sour Cream"
      ),
      createItem(
        'breakfast-tacos',
        'Breakfast Tacos',
        1195,
        "2 Eggs Scrambled, O'Brien Potatoes, Sausage or Bacon, Cheddar Cheese, Stuffed in 3 Flour Tortillas, Frijoles, Picante"
      ),
      createItem(
  ...
  createCategory(
    ...
    [
      createItem(
        ...
        'Griddle Platter',
        795,
        'Choice of Waffle, 4 French Toast Triangles, or 3 Pancakes'
      ),
      createItem(
        'club-breakfast',
        'Club Breakfast',
      ...
      createItem(
        ...
        'Waffle Platter',
        995,
        '2 Eggs, 1 Belgian Waffle, Choice of 2 Strips Bacon, 1 Sausage Patty, or Half Ham Steak'
      ),
      createItem(
        ...
        { popular: true, imageId: 'pancakes', tags: ['vegetarian'] }
      ),
      createItem(
        'strawberry-cream-waffle',
        'Strawberry Cream Waffle',
        1295,
        '1 Belgian Waffle, Strawberries, Whipped Cream, Strawberry Glaze, Powdered Sugar',
        { tags: ['vegetarian'] }
      ),
      createItem(
      ...
      createItem(
        ...
        'Chicken & Waffle',
        1395,
        '1 Belgian Waffle, 3 Chicken Tender Strips'
      ),
      createItem('single-waffle', 'Single Waffle', 795, '1 Belgian Waffle', {
        tags: ['vegetarian'],
      }),
      createItem('single-french-toast', 'Single French Toast', 495, '2 French Toast Triangles', {
        tags: ['vegetarian'],
      }),
      createItem('single-pancake', 'Single Pancake', 395, '1 Buttermilk Pancake', {
        tags: ['vegetarian'],
      }),
      createItem('short-stack', 'Short Stack', 595, '2 Buttermilk Pancakes', {
        tags: ['vegetarian'],
      }),
    ]
  ),
  createCategory(
    ...
    [
      ...
      createItem(
        ...
        'Chili & Cheddar Cheese Omelette',
        1395,
        '3 Egg Omelette, Chili, Cheddar Cheese, Onions, 1 Side Choice, 1 Bread Choice'
      ),
      createItem(
        'denver-omelette',
        'Denver Omelette',
      ...
      createItem(
        ...
        'Acapulco Omelette',
        1395,
        '3 Egg Omelette, Taco Meat, Cheddar Cheese, Jack Cheese, Picante, 1 Side Choice, 1 Bread Choice'
      ),
      createItem(
        'texan-omelette',
        'Texan Omelette',
        ...
        { popular: true, imageId: 'texan-omelette' }
      ),
      createItem(
        'hangover-omelette',
        'Hangover Omelette',
      ...
      createItem(
        ...
        'Philly Cheesesteak Omelette',
        1495,
        '3 Egg Omelette, Thinly Sliced Ribeye, Bell Pepper, Onions, Mushrooms, Swiss Cheese, 1 Side Choice, 1 Bread Choice'
      ),
    ]
  ),
];
